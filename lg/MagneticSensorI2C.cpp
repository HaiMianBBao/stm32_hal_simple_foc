...
void MagneticSensorI2C::init(void)
{
...
int MagneticSensorI2C::read(uint8_t angle_reg_msb)
{
  ...
  // HAL_I2C_Mem_Read_DMA(&hi2c1, chip_address, angle_reg_msb, I2C_MEMADD_SIZE_8BIT, readArray, 2);
  HAL_I2C_Mem_Read(&hi2c1, chip_address, angle_reg_msb, I2C_MEMADD_SIZE_8BIT, readArray, 2, 0xff);
